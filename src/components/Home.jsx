...
function Home() {
    return (
        <div className="bg-blue-950 font-sans flex flex-col gap-8 p-20 md:p-12 lg:p-20 content-evenly">
            ...
            <div className="px-3">
                <div className="text-white font-semibold text-5xl leading-normal md:text-4xl lg:text-6xl">
                    Build a payment solution that's right for you with
                </div>
                <div className="text-white font-semibold text-5xl md:text-4xl lg:text-6xl">
